...
private slots:
    ...
    void sendAngleVertical2(double angleVertical);
    void sendAngleHorizontal3(double angleVertical, double angleHorizontal);
    void sendAngleRotation4(double angleRotation);
