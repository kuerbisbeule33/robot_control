    ...
    : QWidget{parent}
{
    ...
    PushButton* left1 = new PushButton(slider1, step, QIcon("://left.png"), "", this);
    PushButton* right1 = new PushButton(slider1, step, QIcon("://right.png"), "", this);
    ...
    QHBoxLayout* slider1HBox = new QHBoxLayout(this);
    ...
    //motor 2
    QSlider* slider2 = new QSlider(Qt::Orientation::Horizontal, this);
    slider2->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Fixed);
    slider2->setMaximum(360);
    QSpinBox* angle2 = new QSpinBox(this);
    ...
    PushButton* left2 = new PushButton(slider2, step, QIcon("://left.png"), "", this);
    PushButton* right2 = new PushButton(slider2, step, QIcon("://right.png"), "", this);
    ...
    QHBoxLayout* slider2HBox = new QHBoxLayout(this);
    ...
    //motor 3
    QSlider* slider3 = new QSlider(Qt::Orientation::Horizontal, this);
    slider3->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Fixed);
    slider3->setMaximum(360);
    QSpinBox* angle3 = new QSpinBox(this);
    ...
    PushButton* left3 = new PushButton(slider3, step, QIcon("://left.png"), "", this);
    PushButton* right3 = new PushButton(slider3, step, QIcon("://right.png"), "", this);
